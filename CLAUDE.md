...
This project is indexed by GitNexus as **gated-uat** (1005 symbols, 2095 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
